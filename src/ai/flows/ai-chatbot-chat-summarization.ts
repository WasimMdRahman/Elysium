...
/**
 * @fileOverview Summarizes the chat history for the AI Chatbot.
 *
...
const prompt = ai.definePrompt({
  ...
  \"\"\"{{chatHistory}}\"\"\"\n
  Provide a concise summary of the main topics discussed and any important information exchanged.`,
});
